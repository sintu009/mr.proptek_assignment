...
import { addTask, toggleTask, deleteTask, setSearchQuery, reorderTasks } from './store/todoSlice';
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 bg-purple-400 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-white text-4xl font-bold mb-8">Design team meeting</h2>
